    ...
    def parse_and_save(
        ...
        if date_to is None and date_to is None:
            ...
            for curr in currencies:
                ...
                data = (datetime.now().date(), curr, self.base_currency_code, value, self.source_id, datetime.now())
            ...
            for date in daterange:
                ...
                for curr in currencies:
                    value = currencies[curr]
                    data = (date_, curr, self.base_currency_code, value, self.source_id, datetime.now())
                    print(data)
                    insert_data_into_table(table_name, data)
