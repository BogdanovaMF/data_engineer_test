...
DROP TABLE IF EXISTS dm.currencies_en;

CREATE TABLE IF NOT EXISTS dm.currencies_en (
    exchange_date DATE COMMENT 'Дата обмена валюты',
    language VARCHAR(20) COMMENT 'Конвентируемая валюта на английском языке',
